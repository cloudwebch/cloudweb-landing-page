...
function enqueue_assets() {
	...
	if ( is_page_template( 'genesis-landing-page.php' ) || is_page_template( 'cloudweb-landing-page.php' ) ) {
		...
		.wp-block-gravity-forms-cover .gform_wrapper .ginput_container_checkbox .gfield_checkbox input + label {background-color: var(--gform-theme-color-secondary);border:2px solid var(--gform-theme-control-border-color);color: var(--gform-theme-color-secondary-contrast);margin-inline:0;padding:10px;cursor:pointer;min-width:225px;text-align: center;}
		.wp-block-gravity-forms-cover .gform_wrapper .ginput_container_checkbox .gfield_checkbox input:checked + label, .wp-block-gravity-forms-cover .gform_wrapper .ginput_container_checkbox .gfield_checkbox input + label:hover,.wp-block-gravity-forms-cover .gform_wrapper .ginput_container_checkbox .gfield_checkbox input + label:focus{color: var(--gform-theme-color-secondary-contrast);background-color: var(--gform-theme-control-border-color);}
