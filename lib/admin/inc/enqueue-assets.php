...
function enqueue_assets() {
	...
	if ( is_page_template( 'genesis-landing-page.php' ) || is_page_template( 'cloudweb-landing-page.php' ) ) {
		...
		.cloudweb-landing-page .wp-block-gravity-forms-cover.alignfull,.cloudweb-landing-page .wp-block-gravity-forms-cover.full{margin-inline: calc(-1 * (100vw - {$site_size}px) / 2)!important;width:auto;max-width:none}
		body.cloudweb-landing-page .wp-block-gravity-forms-cover.alignfull,body.cloudweb-landing-page .wp-block-gravity-forms-cover.full{width:auto!important;max-width:100dvw}
		...
		.wp-block-gravity-forms-cover .gform_wrapper{background-color: var(--wp-block-gravity-forms-cover--background);padding:33px 60px 33px;}
		...
		.wp-block-gravity-forms-cover .gform_wrapper .ginput_container_checkbox .gfield_checkbox{display: flex;flex-direction: row; gap: 22px;flex-wrap: wrap;justify-content: center;margin-bottom:13px;}
		...
		.wp-block-gravity-forms-cover .gform_wrapper .gform_footer, .wp-block-gravity-forms-cover .gform_wrapper .gform_page_footer{margin-block:24px;justify-content: center;}
